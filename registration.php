...
<?php
if(isset($_POST['s'])){
    $con = mysqli_connect('localhost', 'root', 'Liam5641.');
    if(!$con)
    {
         ...
         <div class="bg-agile">
            ...
            <div class="login-form">    
                <form action="#" method="post">
                    ...
                    <p style="color:#dfdfdf">ID Number</p><input type="text" name="aadhar_number" maxlength="8" required pattern="\d{1,8}" id="aadh" onfocusout="f1()" />
                    ...
                    <div class="right-agileits">
                        <p style="color:#dfdfdf">Mobile</p><input type="text" name="mobile_number" maxlength="10" required pattern="\d{1,10}" id="mobno" onfocusout="f1()" />
                    </div>
